...
?>
        ...
        <div class="container">
            ...
            <div class="header">
                ...
                <div class="nav">
                    <ul>
                        <right<li><a href="./index.php">Home</a></li></right>
                        <right<li><a href="./header.php">Admin</a></li></right>
                        <right<li><a href="#Lego">Lego</a></li></right>
                        <right<li><a href="#Figure">Figure</a></li></right>
                        <right<li><a href="#Clay">Clay</a></li></right>
